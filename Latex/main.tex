...
where $A=\begin{pmatrix} 
	\frac{1}{\tau_1} & -\omega \\
	\omega & \frac{1}{\tau_2}
\end{pmatrix}$ and $\Sigma$ is a lower triangular matrix with positive diagonal elements whereas $\tau_1$ and $\tau_2$ are two autocorrelations time scale for each component of the velocity.
