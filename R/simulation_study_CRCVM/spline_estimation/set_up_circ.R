...
knots_DistanceShore=list(theta=seq(-pi,pi,len=SP_DF),DistanceShore=seq(0.5,8,len=SP_DF))
...
knots_ExpShore=list(theta=seq(-pi,pi,len=SP_DF),ExpShore=seq(1/8,1/0.5,len=SP_DF))
