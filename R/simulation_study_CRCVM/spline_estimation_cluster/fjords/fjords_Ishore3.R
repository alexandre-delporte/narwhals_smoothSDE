...
write_estimates_csv=function(model,name) {
  ...
  write.csv(coeffs_df,paste("result_",domain_name,"_",name,"_seed",seed,
                            "_",hyper_params_file_name,".csv",sep=""), row.names=FALSE)
...
#### High number of ID
write_estimates_csv(ctcrw_lf_le_hID,"ctcrw_lf_le_hID")
#### Low number of ID
write_estimates_csv(ctcrw_lf_le_lID,"ctcrw_lf_le_lID")
...
#### Low number of ID
write_estimates_csv(ctcrw_hf_he_lID,"tcrw_hf_he_lID")
### High frequency low error ----
