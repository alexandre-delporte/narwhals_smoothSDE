...
formulas <- list(mu1=~1,mu2=~1,tau=~s(theta,k=8,bs="cc"),
...
crcvm_splines_lf_he$update_map(list("log_lambda"=factor(c(1,rep(NA,2)))))
crcvm_splines_lf_he$update_lambda(c(1,10^-7,10^-13))
#fit
