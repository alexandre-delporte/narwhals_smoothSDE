...
if (!(dir.exists(paste("results",hyperparams_file)))) {
...
write_estimates_csv=function(model,model_name) {
  ...
  write.csv(path=file.path(paste("results_",hyper_params_file_name)),coeffs_df,paste("result_",domain_name,"_",model_name,
