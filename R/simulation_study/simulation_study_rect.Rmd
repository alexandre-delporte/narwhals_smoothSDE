...
p=ggplotly(p)
saveWidget(p, file ="crcvm_rect_hf_ne1/all_batches_coeffs_crcvm_rect_hf_ne1.png")
...
p=ggplotly(p)
saveWidget(p, file ="crcvm_rect_hf_ne2/all_batches_coeffs_crcvm_rect_hf_ne2.png")
...
p=ggplotly(p)
saveWidget(p, file ="crcvm_rect_hf_e1/all_batches_coeffs_crcvm_rect_hf_e1.png")
...
p=ggplotly(p)
saveWidget(p, file ="crcvm_rect_hf_e2/all_batches_coeffs_crcvm_rect_hf_e2.png")
```
