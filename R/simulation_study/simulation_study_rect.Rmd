...
## Estimate with ExpShore covariate and tensor splines te
...
```{r compute biais and rmse ExpShore splines}
biais=c()
rmse=c()
...
names(biais)=c(paste("omega.",names(sp_coeff_ExpShore),sep=""),"tau.(Intercept)","nu.(Intercept)","tau.(ID)","nu.(ID)")
names(rmse)=c(paste("omega.",names(sp_coeff_ExpShore),sep=""),"tau.(Intercept)","nu.(Intercept)","tau.(ID)","nu.(ID)")

```

```{r print biais ExpShore splines}
biais
```

```{r print rmse ExpShore splines }
rmse
```
