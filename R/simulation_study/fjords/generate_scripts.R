...
seeds=1:100
script_ExpShore<-readLines("base_script_fjords_ExpShore.R")
script_DistanceShore<-readLines("base_script_fjords_DistanceShore.R")
...
for (seed in seeds) {
  ...
  writeLines(script_ExpShore[-c(1:13)], paste("fjords_ExpShore",seed,".R",sep=""))
  writeLines(script_DistanceShore[-c(1:13)], paste("fjords_DistanceShore",seed,".R",sep=""))
}
