...
# Fit baseline with 35m measurement error
sigma_obs=0.035
H=array(rep(sigma_obs^2*diag(2),n_pre),dim=c(2,2,n_pre))

baseline0_35m<- SDE$new(formulas = formulas,data = dataBE2,type = "RACVM",response = c("x","y"),
...
```{r results baseline0}
estimates_bas0_35m=as.list(baseline0_35m$tmb_rep(),what="Est")
std_bas0_35m=as.list(baseline0_35m$tmb_rep(),what="Std")
...
#initial parameters
par0 <- c(0,0,1,4,0)
init_lambda=c(1/0.2^2,1/0.2^2,0.01)
...
baseline1_35m<- SDE$new(formulas = formulas,data = dataBE2,type = "RACVM",response = c("x","y"),
                    par0 = par0,other_data=list("H"=H),fixpar=c("mu1","mu2"),
                    map=list(log_lambda=factor(c("tau.s(ID)","nu.s(ID)",NA))))

baseline1_35m$update_lambda(init_lambda)
...
```{r results baseline1}
estimates_bas1_35m=as.list(baseline1_35m$tmb_rep(),what="Est")
std_bas1_35m=as.list(baseline1_35m$tmb_rep(),what="Std")
...
plots_bas1_35m=baseline1_35m$get_all_plots(baseline=NULL,model_name="baseline1_35m",show_CI="pointwise",save=TRUE)
...
baseline2_35m<- SDE$new(formulas = formulas,data = dataBE2,type = "RACVM",
                    response = c("x","y"),par0 = par0,other_data=list("H"=H),
                    fixpar=c("mu1","mu2"),map=list("log_lambda"=factor(c(1,2,rep(NA,4)))))


baseline2_35m$update_lambda(init_lambda)
baseline2_35m$fit()
...
estimates_bas2_35m=as.list(baseline2_35m$tmb_rep(),what="Est")
std_bas2_35m=as.list(baseline2_35m$tmb_rep(),what="Std")
...
plots_bas2_35m=baseline2_35m$get_all_plots(baseline=NULL,model_name="baseline2_35m",xmin=xmin,xmax=xmax,show_CI="pointwise",save=TRUE)
...
post_coeff_bas2_35m=baseline2_35m$post_coeff(n_post=1000)
post_par_bas2_35m=list("tau0"=exp(post_coeff_bas2_35m$coeff_fe[,"tau.(Intercept)"]),
              "nu0"=exp(post_coeff_bas2_35m$coeff_fe[,"nu.(Intercept)"]),
              "omega0"=post_coeff_bas2_35m$coeff_fe[,"omega.(Intercept)"],
              "sigma_tau"=1/sqrt(exp(post_coeff_bas2_35m$log_lambda[,1])),
              "sigma_nu"=1/sqrt(exp(post_coeff_bas2_35m$log_lambda[,2])))
mean_par_bas2_35m=lapply(post_par_bas2_35m,mean)
sd_par_bas2_35m=lapply(post_par_bas2_35m,sd)
...
baseline3_35m<- SDE$new(formulas = formulas,data = dataBE2,type = "RACVM",
                    response = c("x","y"),par0 = par0,other_data=list("H"=H),
                    fixpar=c("mu1","mu2"),map=list("log_lambda"=factor(c(1,2,rep(NA,4)))))

baseline3_35m$update_lambda(init_lambda)
baseline3_35m$fit()
...
estimates_bas3_35m=as.list(baseline3_35m$tmb_rep(),what="Est")
std_bas3_35m=as.list(baseline3_35m$tmb_rep(),what="Std")
...
plots_bas3_35m=baseline3_35m$get_all_plots(baseline=NULL,model_name="baseline3_35m",
...
post_coeff_bas3_35m=baseline3_35m$post_coeff(n_post=1000)
post_par_bas3_35m=list("tau0"=exp(post_coeff_bas3_35m$coeff_fe[,"tau.(Intercept)"]),
              "nu0"=exp(post_coeff_bas3_35m$coeff_fe[,"nu.(Intercept)"]),
              "omega0"=post_coeff_bas3_35m$coeff_fe[,"omega.(Intercept)"],
              "sigma_tau"=1/sqrt(exp(post_coeff_bas3_35m$log_lambda[,1])),
              "sigma_nu"=1/sqrt(exp(post_coeff_bas3_35m$log_lambda[,2])))
mean_par_bas3_35m=lapply(post_par_bas3_35m,mean)
sd_par_bas3_35m=lapply(post_par_bas3_35m,sd)
...
response1_sp_35m<- SDE$new(formulas = formulas,data = dataAE,type = "RACVM",response = c("x","y"),
                    par0 = par0,other_data=list("H"=H),fixpar=c("mu1","mu2"),
...
new_coeff_re=c(rep(0,2),baseline1_35m$coeff_re()[paste("tau.s(ID).",1:N,sep=""),1],rep(0,2),
               baseline1_35m$coeff_re()[paste("nu.s(ID).",1:N,sep=""),1],
               baseline1_35m$coeff_re()[paste("omega.s(AngleNormal).",1:4,sep=""),1])
new_lambda=c(1,baseline1_35m$lambda()["tau.s(ID)",1],1,baseline1_35m$lambda()["nu.s(ID)",1],
             baseline1_35m$lambda()["omega.s(AngleNormal)",1])
response1_sp_35m$update_coeff_re(new_coeff_re)
response1_sp_35m$update_coeff_fe(baseline1_35m$coeff_fe()[,1])

response1_sp_35m$update_lambda(new_lambda)

response1_sp_35m$fit()
...
estimates_res1_sp_35m=as.list(response1_sp_35m$tmb_rep(),what="Est")
std_res1_sp_35m=as.list(response1_sp_35m$tmb_rep(),what="Std")
...
plots_res1_sp_35m=response1_sp_35m$get_all_plots(baseline=baseline1_35m,xmin=xmin,xmax=xmax,link=link,xlabel=xlabel,
                            model_name="response1_sp_35m",show_CI="pointwise",save=TRUE)
...
post_coeff_res1_sp_35m=response1_sp_35m$post_coeff(n_post=1000)
post_par_res1_sp_35m=list("tau0"=exp(post_coeff_res1_sp_35m$coeff_fe[,"tau.(Intercept)"]),
              "nu0"=exp(post_coeff_res1_sp_35m$coeff_fe[,"nu.(Intercept)"]),
              "omega0"=post_coeff_res1_sp_35m$coeff_fe[,"omega.(Intercept)"],
              "sigma_tau"=1/sqrt(exp(post_coeff_res1_sp_35m$log_lambda[,1])),
              "sigma_nu"=1/sqrt(exp(post_coeff_res1_sp_35m$log_lambda[,2])))
mean_par_res1_sp_35m=lapply(post_par_res1_sp_35m,mean)
sd_par_res1_sp_35m=lapply(post_par_res1_sp_35m,sd)
...
response2_sp_50m$update_coeff_fe(baseline2$coeff_fe()[,1])
...
response2_sp_75m$update_coeff_fe(baseline2$coeff_fe()[,1])
...
response2_sp_100m$update_coeff_fe(baseline2$coeff_fe()[,1])
